		...
		<header data-sal="fade" data-sal-delay="0" data-sal-easing="ease" data-sal-duration="500">
			...
			<div className="contacts">
				...
				<div className="inner">
					...
					<a href="https://www.hackerrank.com/adrien_sk" target="_blank" rel="noopener noreferrer">
						<FontAwesomeIcon icon={faHackerrank} data-sal="slide-down" data-sal-delay="1000" data-sal-easing="ease" data-sal-duration="500"/>
						</a>
				</div>
			</div>
		</header>
